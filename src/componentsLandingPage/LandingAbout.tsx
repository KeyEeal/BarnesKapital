  ...
  return (
    <>
      <PageMeta
        ...
        description="Barnes Kapital is a self-funded, family-owned private equity firm guided by Faith, Family, and Funds. We partner with owner-operators for long-term, stewardship-driven investment."
        canonical={BASE_URL}
        og={{
          type: "website",
          url: BASE_URL,
